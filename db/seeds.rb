...
spencer = User.create!(username: "si_hikes", age: 11, political_affiliation: "CSS", email:"best_hikes@aa.io")
diego = User.create!(username: "pooch_app", age: 11, political_affiliation: "JavaScript", email: "pooch@aa.io")
